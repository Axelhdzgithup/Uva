...
slide1.addEventListener('change', function () {
    if (slide1.checked) {
        ...
        infoButton.href = 'escolares.html'; // Cambia la URL
    }
});
...
slide2.addEventListener('change', function () {
    if (slide2.checked) {
        ...
        infoButton.href = 'navidad.html'; // Cambia la URL
    }
});
...
slide3.addEventListener('change', function () {
    if (slide3.checked) {
        ...
        infoButton.href = 'septiembre.html'; // Cambia la URL
    }
});
...
slide4.addEventListener('change', function () {
    if (slide4.checked) {
        ...
        infoButton.href = 'noviembre.html'; // Cambia la URL
    }
});
...
slide5.addEventListener('change', function () {
    if (slide5.checked) {
        ...
        infoButton.href = 'halloween.html'; // Cambia la URL
    }
});
...
slide6.addEventListener('change', function () {
    if (slide6.checked) {
        ...
        infoButton.href = 'enero.html'; // Cambia la URL
    }
});

slide7.addEventListener('change', function () {
    if (slide7.checked) {
        infoButton.textContent = 'Febrero'; // Cambia el texto según sea necesario
        infoButton.href = 'febrero.html'; // Cambia la URL
    }
});
